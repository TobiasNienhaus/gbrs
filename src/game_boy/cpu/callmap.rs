...
impl Cpu<'_> {
    pub fn handle_instructions(&mut self) {
        ...
        match instruction {
            ...
            0x06 => self.ld_const8_to_r8(Register8::B, todo!("Needs const 8 bit value")),
            0x07 => self.rlca(),
            0x08 => self.ld_sp_to_const16addr(todo!("Needs const 16 bit address")),
            ...
            0x16 => self.ld_const8_to_r8(Register8::D, todo!("Needs const 8 bit value")),
            0x17 => self.rla(),
            0x18 => self.jr(todo!("Needs const 8 bit relative signed value")),
            ...
            0x1E => self.ld_const8_to_r8(Register8::E, todo!("Needs const 8 bit value")),
            0x1F => self.rra(),
            0x20 => self.jr_cc(Condition::ZNotSet, todo!("Needs const 8 bit relative signed value")),
            0x21 => self.ld_const16_to_r16(Register16::HL, todo!("Needs const 16 bit value")),
            0x22 => self.ld_a_to_hl_and_inc(),
            0x23 => self.inc_r16(Register16::HL),
            0x24 => self.inc_r8(Register8::H),
            0x25 => self.dec_r8(Register8::H),
            0x26 => self.ld_const8_to_r8(Register8::H, todo!("Needs const 8 bit value")),
            0x27 => self.daa(),
            0x28 => self.jr_cc(Condition::ZSet, todo!("Needs const 8 bit relative signed value")),
            ...
            0x2E => self.ld_const8_to_r8(Register8::L, todo!("Needs const 8 bit value")),
            0x2F => self.cpl(),
            0x30 => self.jr_cc(Condition::CNotSet, todo!("Needs const 8 bit relative signed value")),
            0x31 => self.ld_const16_to_sp(todo!("Needs const 16 bit value")),
            0x32 => self.ld_a_to_hl_and_dec(),
            0x33 => self.inc_sp(),
            0x34 => self.inc_hl(),
            0x35 => self.dec_hl(),
            0x36 => self.ld_const8_to_hl(todo!("Needs const 8 bit value")),
            0x37 => self.scf(),
            0x38 => self.jr_cc(Condition::CSet, todo!("Needs const 8 bit relative signed value")),
            0x39 => self.add_sp_to_hl(),
            0x3A => self.ld_hl_to_a_and_dec(),
            0x3B => self.dec_sp(),
            0x3C => self.inc_r8(Register8::A),
            0x3D => self.dec_r8(Register8::A),
            0x3E => self.ld_const8_to_r8(Register8::A, todo!("Needs const 8 bit value")),
            0x3F => self.ccf(),
            ...
            0xC2 => self.jp_cc(Condition::ZNotSet, todo!("Needs const 16 bit address")),
            0xC3 => self.jp(todo!("Needs const 16 bit address")),
            0xC4 => self.call_cc(Condition::ZNotSet, todo!("Needs const 16 bit address")),
            0xC5 => self.push_r16(Register16::BC),
            0xC6 => self.add(todo!("Needs const 8 bit value")),
            ...
            0xD2 => self.jp_cc(Condition::CNotSet, todo!("Needs const 16 bit address")),
            0xD4 => self.call_cc(Condition::CNotSet, todo!("Needs const 16 bit address")),
            0xD5 => self.push_r16(Register16::DE),
            0xD6 => self.sub(todo!("Needs const 8 bit value")),
            0xD7 => self.rst(ResetVec::Vec3),
            0xD8 => self.ret_cc(Condition::CSet),
            0xD9 => self.reti(),
            0xDA => self.jp_cc(Condition::CSet, todo!("Needs const 16 bit address")),
            0xDC => self.call_cc(Condition::CSet, todo!("Needs const 16 bit address")),
            0xDE => self.sbc(todo!("Needs const 8 bit value")),
            0xDF => self.rst(ResetVec::Vec4),
            0xE0 => self.ldh_a_to_const16addr(0xFF00 + (todo!("Needs 8 bit constant address") as u16)),
            0xE1 => self.pop_r16(Register16::HL),
            0xE2 => self.ldh_a_to_ff00_plus_c(),
            0xE5 => self.push_r16(Register16::HL),
            0xE6 => self.and(todo!("Needs const 8 bit value")),
            0xE7 => self.rst(ResetVec::Vec5),
            0xE8 => self.add_e8_to_sp(todo!("Needs const 8 bit signed data")),
            0xE9 => self.jp_hl(),
            0xEA => self.ld_a_to_const16addr(todo!("Needs const 16 bit address")),
            0xEE => self.xor(todo!("Needs const 8 bit value")),
            0xEF => self.rst(ResetVec::Vec6),
            0xF0 => self.ldh_const16addr_to_a(0xFF00 + (todo!("Needs 8 bit constant address") as u16)),
            0xF1 => self.pop_af(),
            0xF2 => self.ldh_ff00_plus_c_to_a(),
            0xF3 => self.di(),
            0xF5 => self.push_af(),
            0xF6 => self.or(todo!("Needs const 8 bit value")),
            0xF7 => self.rst(ResetVec::Vec7),
            0xF8 => self.ld_sp_plus_e8_to_hl(todo!("Needs 8 bit signed data")),
            0xF9 => self.ld_hl_to_sp(),
            0xFA => self.ld_const16addr_to_a(todo!("Needs const 16 bit address")),
            0xFB => self.ei(),
